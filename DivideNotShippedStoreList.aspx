<%@ Page Title="배송권역 매장별 미출고 리스트" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DivideNotShippedStoreList.aspx.cs" Inherits="SmartLogisticsDeliveryProxySystem_Search.DivideNotShippedStoreList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        <div class="row row-cols-auto align-items-center justify-content-center">
            <div class="col">
                <asp:Label ID="Label4" runat="server" Text="배송권역 매장별 미출고 리스트" Font-Bold="True" Font-Size="1.7em" ForeColor="#3366FF"></asp:Label>
            </div>
        </div>
        <div class="row row-cols-auto align-items-center justify-content-center">
            <div class="col">
    ...
    <div class="container">
        <asp:GridView ID="GridView1" CssClass="table table-group-divider" runat="server" AutoGenerateColumns="false"
            DataKeyNames="물류코드, 물류명, 상세, 매장명, 입고수량, 출고수량, 미출고수량" Font-Size ="0.84em"
