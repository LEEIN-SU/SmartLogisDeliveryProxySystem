<%@ Page Title="시간대별 센터입고 현황" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CarTimeCenterIn.aspx.cs" Inherits="SmartLogisticsDeliveryProxySystem_Search.CarTimeCenterIn" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <div class="container">
        <div class="row row-cols-auto align-items-center justify-content-center">
            <div class="col">
                <asp:Label ID="Label4" runat="server" Text="시간대별 센터입고 현황" Font-Bold="True" Font-Size="2em" ForeColor="#3366FF"></asp:Label>
            </div>
        </div>
        <div class="row row-cols-auto align-items-center justify-content-center">
            <div class="col">
        ...
        <div class="row row-cols-auto align-items-center justify-content-center">            
            ...
            <div class="text-right col">
                <asp:Label ID="Label2" runat="server" Text="입고수량" Font-Size="0.9em"></asp:Label>
            </div>            
            <div class="text-left col">
