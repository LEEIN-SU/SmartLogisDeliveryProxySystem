...
{
    public partial class StoreBuildingGroup : System.Web.UI.Page
    {
        int 집하수량 = 0;
        int 입고수량 = 0;
        int 출고수량 = 0;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    this.txtInDate.Text = DateTime.Now.ToString("yyyyMMdd");
                }
                else
                {
        ...
        {
            SqlDataSource1.SelectParameters["입고일자"].DefaultValue = this.txtInDate.Text.ToString();
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                집하수량 += Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "집하"));
            ...
            else if (e.Row.RowType == DataControlRowType.Footer)
            {
                ...
                e.Row.Cells[2].Text = 집하수량.ToString("N0");
