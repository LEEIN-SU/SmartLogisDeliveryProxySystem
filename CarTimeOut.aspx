<%@ Page Title="시간대별 출고 현황" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CarTimeOut.aspx.cs" Inherits="SmartLogisticsDeliveryProxySystem_Search.CarTimeOut" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <div class="container">
        <div class="row row-cols-auto align-items-center justify-content-center">
            <div class="col">
                <asp:Label ID="Label4" runat="server" Text="시간대별 출고 현황" Font-Bold="True" Font-Size="2em" ForeColor="#3366FF"></asp:Label>
            </div>
        </div>
        <div class="row row-cols-auto align-items-center justify-content-center">
            <div class="col">
        ...
        <div class="row row-cols-auto align-items-center justify-content-center">            
            ...
            <div class="text-right col">
                <asp:Label ID="Label2" runat="server" Text="출고수량" Font-Size="0.9em"></asp:Label>
            </div>            
            <div class="text-left col">
    ...
    <div class="container justify-content-center">
        <asp:GridView ID="GridView1" CssClass="table table-group-divider" runat="server" AutoGenerateColumns="false" Font-Size ="0.84em"
            DataKeyNames="출고일자, 일자, 소계, 시, 분, 차량번호, 차수, 수량, 누계" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle"
