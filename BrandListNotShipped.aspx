<%@ Page Title="브랜드 매장별 미출고 리스트" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BrandListNotShipped.aspx.cs" Inherits="SmartLogisticsDeliveryProxySystem_Search.BrandListNotShipped" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        <asp:GridView ID="GridView1" CssClass="table table-group-divider" runat="server"
            ...
            <Columns>
                <asp:BoundField DataField="입고일" HeaderText="집하일" SortExpression="입고일" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" Visible="false">
                </asp:BoundField>
                ...
                <asp:BoundField DataField="브랜드매장명" HeaderText="브랜드매장명" SortExpression="브랜드매장명" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">
                </asp:BoundField>
