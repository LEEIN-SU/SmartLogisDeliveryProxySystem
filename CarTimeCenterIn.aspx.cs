...
{
    public partial class CarTimeCenterIn : System.Web.UI.Page
    {
        ...
        private void date_Reload()
        {
            ...
            string sQuery = string.Format(""
                + " EXEC usp_웹_배송의뢰서마스터_시간대별_센터입고_메인_Get '{0}' ",
                txtOutDate.Text);

            WMScon = new SqlConnection(WMS_SERVER);
            WMScon.Open();

            oDT = new DataTable("usp_웹_배송의뢰서마스터_시간대별_센터입고_메인_Get");
        ...
        protected void btnExcelPort_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = new DataTable("usp_웹_배송의뢰서마스터_시간대별_센터입고_메인_Get");
            ...
            string sFileName = txtOutDate.Text + "_시간대별센터입고_" + DateTime.Now.ToString("yyyyMMdd");
