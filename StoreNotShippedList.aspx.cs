...
{
    public partial class StoreNotShippedList : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            string sQuery = string.Format(""
                + " EXEC usp_웹_배송의뢰서마스터_집합건물별_미출고_리스트_Get '{0}', '{1}' ",
                s입고일자,
                s건물구분);
            ...
            oDT = new DataTable("usp_웹_배송의뢰서마스터_집합건물별_미출고_리스트_Get");
